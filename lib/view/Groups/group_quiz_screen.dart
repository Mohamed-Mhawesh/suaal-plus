...
import 'package:suaal_plus/view/Components/group_individually_progress_timer.dart';
...
class GroupQuizScreen extends StatelessWidget {
  ...
  final GroupQuizController controller = Get.put(GroupQuizController());
    ...
    return WillPopScope(
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: GetBuilder<GroupQuizController>(
                          ...
                          SizedBox(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                const Spacer(flex: 1),
                                GroupIndividuallyProgressTimer()
                              ],
                            ),
                          ),
                          Expanded(
