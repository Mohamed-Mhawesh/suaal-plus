...
class MyChoiceChip extends StatelessWidget {
  ...
  Color chosenColor(String process,int chipId){
    switch (process){
      case "gr":{if(controller.graduated==chipId){return kPrimaryColor;}else{return Colors.white;} }
      case "ci":{if(controller.chosenCity==chipId){return kPrimaryColor;}else{return Colors.white;}}
  ...
  Color chosenTextColor(String process,int chipId){
    switch (process){
      case "gr":{if(controller.graduated==chipId){return Colors.white;}else{return kPrimaryColor;} }
      case "ci":{if(controller.chosenCity==chipId){return Colors.white;}else{return kPrimaryColor;}}
